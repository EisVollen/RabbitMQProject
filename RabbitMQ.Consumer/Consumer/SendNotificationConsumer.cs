...
{
    public class NotificationTaskStateConsumer : IConsumer<SendingObjectMessage>
    {
    ...
    //    private string MessageTypeCode = "notificationTaskState";
        ...
        {
            Console.WriteLine("Costcurtor NotificationTaskStateConsumer");
            //_config = config;
        ...
        public Task Consume(ConsumeContext<SendingObjectMessage> context)
        {
            Console.WriteLine("Consume NotificationTaskStateConsumer");
            var json = context.Message.Message.MessageBody;
